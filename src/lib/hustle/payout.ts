...
export const PLATFORM_FEES: PlatformFee[] = [
  {
    id: "crowdworks",
    name: "クラウドワークス",
    // 公称20%のシステム利用料に、その利用料の消費税10%が加わる。
    // 例: 契約金額（税込）11,000円 → 利用料2,420円 → 実効22%。
    feeRate: 0.22,
    feeNote:
      "システム利用料は契約金額10万円以下の部分が20%＋利用料の消費税（実効22%）、10万円超20万円以下が10%、20万円超が5%。タスク形式も20%＋税。ここでは初心者が受ける価格帯に合わせて実効22%で計算しています。",
