...
export const WORK_TYPES: WorkType[] = [
  {
    ...
    steps: [
      ...
      {
        name: "GHS区分の照合（公的分類データにCAS番号で当てる）",
        by: "approve",
        minutes: 4,
        machineMinutes: 2,
        manualMinutes: 45,
        how:
          "LLMに区分を推論させない。公開されている政府のGHS分類結果に対して、" +
          "CAS番号をキーに決定論的に引く。引けなかった物質だけを人に出す。",
        why: "区分が1段ずれても文章としては自然に読めてしまう。だから推論させず、照合にする。人は「引けなかったもの」と「出典」を見るだけ。",
      },
      {
        ...
        machineMinutes: 1,
        manualMinutes: 30,
        how: "各法令の対象物質リストにCAS番号で当てる。リストの版（公布日）を成果物に残す。",
        why: "改正が頻繁なので、リストの版が古くないかだけ人が見る。",
      },
      {
        name: "16項目の下書き作成",
        by: "auto",
    ...
    note:
      "2026年4月の安衛法改正で、SDS交付義務の対象物質が大きく増えます。資格は要りません。GHS区分は推論させず、公的な分類データへの照合で出します。引けなかった物質だけが人の確認に回ります。",
  },
  {
    id: "risk_assessment",
    label: "化学物質リスクアセスメント",
