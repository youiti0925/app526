...
export const CAPABILITIES: CapabilityDef[] = [
  ...
  },
  {
    ...
    requires: [],
    needsPaid: false,
    detail: "SVG を直接書きます。ロゴ・アイコン・図解・インフォグラフィック・グラフ。無料。",
    patterns: [
  ...
  // ---------------- 出せない ----------------
  {
    ...
    needsPaid: false,
    detail:
      "絵柄そのものが商品なので、SVGでも生成AIでも代わりになりません。受けると必ずあなたが描くことになります。",
    patterns: [
  ...
  },
  {
    ...
    patterns: [
      /(電話|架電|コールセンター|テレアポ|受電|SMS.{0,6}対応)/,
      /(訪問|来社|出社|現地|実地|立会|常駐)/,
      /(撮影|カメラマン|ロケ)/,
      /(接客|配送|梱包|発送作業)/,
    ],
  },
